...
We will be using Lemma 5 in the cases $a=\frac12\sqrt3$, $b=0.5$; $a\leq0.89$, $0.6<b\leq0.921$; $a=0.90$, $b=0.90$; and $a=0.96$, $b=0.76$. Note that $f(a)$ is decreasing in $a$. (see original footnote 1 below)
